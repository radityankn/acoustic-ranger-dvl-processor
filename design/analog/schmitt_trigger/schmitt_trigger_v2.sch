...
N 220 -170 220 -130 {lab=#net3}
N 180 -400 180 -100 {lab=in}
N 220 -150 380 -150 {lab=#net3}
N 220 -350 380 -350 {lab=#net1}
N 410 -310 410 -190 {lab=#net2}
N 220 -250 410 -250 {lab=#net2}
N 410 -250 510 -250 {lab=#net2}
N 440 -150 460 -150 {lab=vdd}
N 440 -350 460 -350 {lab=vss}
...
N 590 -270 590 -230 {lab=out}
N 550 -300 550 -200 {lab=#net2}
N 590 -250 620 -250 {lab=out}
N 510 -250 550 -250 {lab=#net2}
N 590 -360 590 -330 {lab=vdd}
N 590 -170 590 -140 {lab=vss}
N 590 -200 590 -170 {lab=vss}
...
C {opin.sym} 620 -250 0 0 {name=p2 lab=out}
...
C {symbols/nfet_03v3.sym} 570 -200 0 0 {name=q
L=2u
W=2u
nf=1
m=6
...
C {symbols/pfet_03v3.sym} 570 -300 0 0 {name=M8
L=2u
W=2u
nf=1
m=14
...
C {lab_wire.sym} 590 -360 0 1 {name=p5 sig_type=std_logic lab=vdd}
C {lab_wire.sym} 590 -140 0 1 {name=p6 sig_type=std_logic lab=vss}
