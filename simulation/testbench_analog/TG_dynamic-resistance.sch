...
N 710 -330 740 -330 {lab=#net1}
N 500 -390 590 -390 {lab=vdd}
N 740 -330 760 -330 {lab=#net1}
N 630 -270 760 -270 {lab=vss}
N 220 -240 220 -220 {lab=0}
N 220 -330 220 -300 {lab=vin}
N 500 -330 550 -330 {lab=vin}
...
C {devices/code_shown.sym} -10 -740 0 0 {name=NGSPICE1 only_toplevel=true
value="
...
C {vsource.sym} 220 -270 0 0 {name=V3 value=1.65 savecurrent=false}
C {gnd.sym} 220 -220 0 0 {name=l3 lab=0}
C {lab_wire.sym} 220 -330 0 0 {name=p7 sig_type=std_logic lab=vin}
C {lab_wire.sym} 500 -330 0 0 {name=p8 sig_type=std_logic lab=vin}
C {isource.sym} 760 -300 0 0 {name=I0 value=100u}
