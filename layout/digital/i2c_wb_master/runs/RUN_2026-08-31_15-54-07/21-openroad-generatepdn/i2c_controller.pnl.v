module i2c_controller (ACK_I,
 ...
 gf180mcu_fd_sc_mcu7t5v0__clkinv_1 _429_ (.I(\wb_master_state[0] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__clkinv_1 _430_ (.I(RST_I),
    .ZN(_103_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
 ...
 gf180mcu_fd_sc_mcu7t5v0__clkinv_1 _436_ (.I(\send_data_buffer[0] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__clkinv_1 _437_ (.I(i2c_sda_out_pin_ctrl),
    .ZN(i2c_sda_out_pin_ctrl_n),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 ...
 gf180mcu_fd_sc_mcu7t5v0__oai21_1 _678_ (.A1(_250_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor3_1 _679_ (.A1(RST_I),
    .A2(_249_),
    .A3(_251_),
    .ZN(_320_),
    .VDD(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi21_1 _709_ (.A1(_265_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor4_1 _710_ (.A1(RST_I),
    .A2(_249_),
    .A3(_251_),
    .A4(_340_),
    .ZN(_041_),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _776_ (.A1(\addr_pointer_register_internal[0] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _777_ (.A1(RST_I),
    .A2(_387_),
    .ZN(_061_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _778_ (.A1(\addr_pointer_register_internal[1] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _779_ (.A1(RST_I),
    .A2(_388_),
    .ZN(_062_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _780_ (.A1(\addr_pointer_register_internal[2] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _781_ (.A1(RST_I),
    .A2(_389_),
    .ZN(_063_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _782_ (.A1(\addr_pointer_register_internal[3] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _783_ (.A1(RST_I),
    .A2(_390_),
    .ZN(_064_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _784_ (.A1(\addr_pointer_register_internal[4] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _785_ (.A1(RST_I),
    .A2(_391_),
    .ZN(_065_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _786_ (.A1(\addr_pointer_register_internal[5] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _787_ (.A1(RST_I),
    .A2(_392_),
    .ZN(_066_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _788_ (.A1(\addr_pointer_register_internal[6] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _789_ (.A1(RST_I),
    .A2(_393_),
    .ZN(_067_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _790_ (.A1(\addr_pointer_register_internal[7] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _791_ (.A1(RST_I),
    .A2(_394_),
    .ZN(_068_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor3_1 _792_ (.A1(_101_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _793_ (.A1(DAT_O[0]),
    .A2(_386_),
    .B1(_395_),
    .B2(\recv_data_buffer[0] ),
    .ZN(_396_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _794_ (.A1(RST_I),
    .A2(_396_),
    .ZN(_069_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _795_ (.A1(DAT_O[1]),
    .A2(_386_),
    .B1(_395_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _796_ (.A1(RST_I),
    .A2(_397_),
    .ZN(_070_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _797_ (.A1(DAT_O[2]),
    .A2(_386_),
    .B1(_395_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _798_ (.A1(RST_I),
    .A2(_398_),
    .ZN(_071_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _799_ (.A1(DAT_O[3]),
    .A2(_386_),
    .B1(_395_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _800_ (.A1(RST_I),
    .A2(_399_),
    .ZN(_072_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _801_ (.A1(DAT_O[4]),
    .A2(_386_),
    .B1(_395_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _802_ (.A1(RST_I),
    .A2(_400_),
    .ZN(_073_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _803_ (.A1(DAT_O[5]),
    .A2(_386_),
    .B1(_395_),
    .B2(\recv_data_buffer[5] ),
    .ZN(_401_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _804_ (.A1(RST_I),
    .A2(_401_),
    .ZN(_074_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _805_ (.A1(DAT_O[6]),
    .A2(_386_),
    .B1(_395_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _806_ (.A1(RST_I),
    .A2(_402_),
    .ZN(_075_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _807_ (.A1(DAT_O[7]),
    .A2(_386_),
    .B1(_395_),
    .B2(\recv_data_buffer[7] ),
    .ZN(_403_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _808_ (.A1(RST_I),
    .A2(_403_),
    .ZN(_076_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi21_1 _810_ (.A1(_241_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi21_1 _811_ (.A1(WE_O),
    .A2(_386_),
    .B(_395_),
    .ZN(_405_),
    .VDD(VDD),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _812_ (.A1(RST_I),
    .A2(_405_),
    .ZN(_078_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__dffq_1 _897_ (.D(_000_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__dffq_1 _898_ (.D(i2c_scl_in),
    .CLK(CLK_I),
 ...
 gf180mcu_fd_sc_mcu7t5v0__dffq_1 _899_ (.D(\scl_synchroniser_internal[0] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__dffq_1 _900_ (.D(i2c_sda_in),
    .CLK(CLK_I),
 ...
 gf180mcu_fd_sc_mcu7t5v0__dffq_1 _901_ (.D(\sda_synchroniser_internal[0] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__buf_1 _902_ (.I(CYC_O),
    .Z(STB_O),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
