...
set ::env(SIGNOFF_SDC_FILE) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/i2c_wb_master/constraint.sdc
set ::env(CURRENT_NL) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/i2c_wb_master/runs/RUN_2026-08-31_15-54-07/52-openroad-fillinsertion/i2c_controller.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /foss/designs/acoustic-ranger-dvl-processor/layout/digital/i2c_wb_master/runs/RUN_2026-08-31_15-54-07/54-openroad-rcx/nom/i2c_controller.nom.spef \"min_*\" /foss/designs/acoustic-ranger-dvl-processor/layout/digital/i2c_wb_master/runs/RUN_2026-08-31_15-54-07/54-openroad-rcx/min/i2c_controller.min.spef \"max_*\" /foss/designs/acoustic-ranger-dvl-processor/layout/digital/i2c_wb_master/runs/RUN_2026-08-31_15-54-07/54-openroad-rcx/max/i2c_controller.max.spef"
set ::env(CURRENT_ODB) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/i2c_wb_master/runs/RUN_2026-08-31_15-54-07/53-odb-cellfrequencytables/i2c_controller.odb
set ::env(SAVE_SDC) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/i2c_wb_master/runs/RUN_2026-08-31_15-54-07/55-openroad-stapostpnr/i2c_controller.sdc
