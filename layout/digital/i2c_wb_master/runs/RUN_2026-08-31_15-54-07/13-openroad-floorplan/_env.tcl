set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/i2c_wb_master/runs/RUN_2026-08-31_15-54-07/13-openroad-floorplan/config.tracks
...
set ::env(CURRENT_NL) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/i2c_wb_master/runs/RUN_2026-08-31_15-54-07/06-yosys-synthesis/i2c_controller.nl.v
set ::env(SAVE_ODB) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/i2c_wb_master/runs/RUN_2026-08-31_15-54-07/13-openroad-floorplan/i2c_controller.odb
set ::env(SAVE_DEF) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/i2c_wb_master/runs/RUN_2026-08-31_15-54-07/13-openroad-floorplan/i2c_controller.def
set ::env(SAVE_SDC) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/i2c_wb_master/runs/RUN_2026-08-31_15-54-07/13-openroad-floorplan/i2c_controller.sdc
set ::env(SAVE_NL) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/i2c_wb_master/runs/RUN_2026-08-31_15-54-07/13-openroad-floorplan/i2c_controller.nl.v
set ::env(SAVE_PNL) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/i2c_wb_master/runs/RUN_2026-08-31_15-54-07/13-openroad-floorplan/i2c_controller.pnl.v
