...
set ::env(SIGNOFF_SDC_FILE) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/TDC/constraint_signoff.sdc
set ::env(CURRENT_NL) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/TDC/runs/RUN_2026-09-01_09-22-52/52-openroad-fillinsertion/frequency_counter.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /foss/designs/acoustic-ranger-dvl-processor/layout/digital/TDC/runs/RUN_2026-09-01_09-22-52/54-openroad-rcx/nom/frequency_counter.nom.spef \"min_*\" /foss/designs/acoustic-ranger-dvl-processor/layout/digital/TDC/runs/RUN_2026-09-01_09-22-52/54-openroad-rcx/min/frequency_counter.min.spef \"max_*\" /foss/designs/acoustic-ranger-dvl-processor/layout/digital/TDC/runs/RUN_2026-09-01_09-22-52/54-openroad-rcx/max/frequency_counter.max.spef"
set ::env(CURRENT_ODB) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/TDC/runs/RUN_2026-09-01_09-22-52/53-odb-cellfrequencytables/frequency_counter.odb
set ::env(SAVE_SDC) /foss/designs/acoustic-ranger-dvl-processor/layout/digital/TDC/runs/RUN_2026-09-01_09-22-52/55-openroad-stapostpnr/frequency_counter.sdc
