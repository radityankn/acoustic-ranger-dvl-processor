module frequency_counter (ACK_O,
 ...
 gf180mcu_fd_sc_mcu7t5v0__filltie TAP_TAPCELL_ROW_9_151 (.VDD(VDD),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__clkinv_1 _0644_ (.I(DAT_I[6]),
    .ZN(_0165_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
 ...
 gf180mcu_fd_sc_mcu7t5v0__clkinv_1 _0675_ (.I(\pulse_count_threshold_register[3] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__clkinv_1 _0676_ (.I(ADDR_I[1]),
    .ZN(_0197_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__clkinv_1 _0677_ (.I(ADDR_I[2]),
    .ZN(_0198_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__clkinv_1 _0678_ (.I(ADDR_I[4]),
    .ZN(_0199_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__clkinv_1 _0679_ (.I(RST_I),
    .ZN(_0200_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__clkinv_1 _0680_ (.I(signal_input),
    .ZN(_0201_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _0681_ (.A1(ADDR_I[0]),
    .A2(_0197_),
    .ZN(_0202_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__or4_1 _0682_ (.A1(_0199_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__or3_1 _0683_ (.A1(ADDR_I[3]),
    .A2(_0198_),
    .A3(_0203_),
    .Z(_0204_),
    .VDD(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0684_ (.A1(_0202_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _0685_ (.A1(STB_I),
    .A2(CYC_I),
    .ZN(_0206_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0686_ (.A1(RST_I),
    .A2(_0206_),
    .ZN(_0207_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nand3_1 _0687_ (.A1(STB_I),
    .A2(_0200_),
    .A3(CYC_I),
    .ZN(_0208_),
    .VDD(VDD),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor3_1 _0688_ (.A1(ACK_O),
    .A2(ERR_O),
    .A3(_0208_),
    .ZN(_0209_),
    .VDD(VDD),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__and2_1 _0689_ (.A1(WE_I),
    .A2(_0209_),
    .Z(_0210_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _0691_ (.A1(_0205_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi21_1 _0692_ (.A1(DAT_I[3]),
    .A2(_0211_),
    .B(RST_I),
    .ZN(_0213_),
    .VDD(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__oai21_1 _0693_ (.A1(_0196_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0694_ (.A1(DAT_I[4]),
    .A2(_0212_),
    .ZN(_0214_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _0697_ (.A1(\pulse_count_threshold_register[5] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _0698_ (.A1(DAT_I[5]),
    .A2(_0211_),
    .ZN(_0217_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _0702_ (.A1(\pulse_count_threshold_register[7] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _0703_ (.A1(DAT_I[7]),
    .A2(_0211_),
    .ZN(_0220_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nand3_1 _0704_ (.A1(_0200_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__or2_1 _0705_ (.A1(ADDR_I[0]),
    .A2(_0197_),
    .Z(_0221_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi21_1 _0711_ (.A1(\counter_control_status_register[0] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__oai21_1 _0712_ (.A1(DAT_I[0]),
    .A2(_0224_),
    .B(_0200_),
    .ZN(_0228_),
    .VDD(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0713_ (.A1(_0227_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0714_ (.A1(DAT_I[1]),
    .A2(_0224_),
    .ZN(_0229_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0716_ (.A1(_0229_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0717_ (.A1(DAT_I[2]),
    .A2(_0224_),
    .ZN(_0231_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0719_ (.A1(_0231_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0720_ (.A1(DAT_I[3]),
    .A2(_0224_),
    .ZN(_0233_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0722_ (.A1(_0233_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0723_ (.A1(DAT_I[4]),
    .A2(_0224_),
    .ZN(_0235_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0725_ (.A1(_0235_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0726_ (.A1(DAT_I[5]),
    .A2(_0224_),
    .ZN(_0237_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0728_ (.A1(_0237_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _0729_ (.A1(ADDR_I[0]),
    .A2(ADDR_I[1]),
    .ZN(_0239_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi221_1 _0748_ (.A1(_0165_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _0749_ (.A1(DAT_I[7]),
    .A2(_0223_),
    .B1(_0249_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _0750_ (.A1(RST_I),
    .A2(_0250_),
    .ZN(_0020_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _1031_ (.A1(\counter_control_status_register[5] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1032_ (.A1(_0201_),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi21_1 _1048_ (.A1(\counter_control_status_register[5] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__clkinv_1 _1049_ (.I(_0459_),
    .ZN(_0460_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1167_ (.A1(_0529_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor3_1 _1168_ (.A1(ACK_O),
    .A2(ERR_O),
    .A3(_0204_),
    .ZN(_0545_),
    .VDD(VDD),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _1169_ (.A1(WE_I),
    .A2(_0545_),
    .ZN(_0546_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__and2_1 _1171_ (.A1(_0209_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__or4_1 _1172_ (.A1(ADDR_I[4]),
    .A2(ADDR_I[5]),
    .A3(ADDR_I[7]),
    .A4(ADDR_I[6]),
    .Z(_0549_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _1173_ (.A1(ADDR_I[3]),
    .A2(ADDR_I[2]),
    .ZN(_0550_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor3_1 _1175_ (.A1(_0221_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__or3_1 _1176_ (.A1(ADDR_I[3]),
    .A2(ADDR_I[2]),
    .A3(_0203_),
    .Z(_0553_),
    .VDD(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi222_1 _1179_ (.A1(\range_timing_register[8] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor3_1 _1180_ (.A1(ADDR_I[0]),
    .A2(ADDR_I[1]),
    .A3(_0553_),
    .ZN(_0557_),
    .VDD(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _1185_ (.A1(\counter_control_status_register[0] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor3_1 _1186_ (.A1(ADDR_I[0]),
    .A2(ADDR_I[1]),
    .A3(_0204_),
    .ZN(_0563_),
    .VDD(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _1187_ (.A1(\pulse_count_threshold_register[0] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__oai211_1 _1188_ (.A1(WE_I),
    .A2(_0561_),
    .B(_0562_),
    .C(_0564_),
    .ZN(_0565_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _1189_ (.A1(DAT_O[0]),
    .A2(_0547_),
    .B1(_0548_),
    .B2(_0565_),
    .ZN(_0566_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1190_ (.A1(RST_I),
    .A2(_0566_),
    .ZN(_0144_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _1195_ (.A1(\pulse_count_threshold_register[1] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__oai211_1 _1196_ (.A1(WE_I),
    .A2(_0569_),
    .B(_0570_),
    .C(_0571_),
    .ZN(_0572_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _1197_ (.A1(DAT_O[1]),
    .A2(_0547_),
    .B1(_0548_),
    .B2(_0572_),
    .ZN(_0573_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1198_ (.A1(RST_I),
    .A2(_0573_),
    .ZN(_0145_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _1203_ (.A1(\afe_config_bypass_control_register[2] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__oai211_1 _1204_ (.A1(WE_I),
    .A2(_0576_),
    .B(_0577_),
    .C(_0578_),
    .ZN(_0579_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _1205_ (.A1(DAT_O[2]),
    .A2(_0547_),
    .B1(_0548_),
    .B2(_0579_),
    .ZN(_0580_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1206_ (.A1(RST_I),
    .A2(_0580_),
    .ZN(_0146_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _1211_ (.A1(\counter_control_status_register[3] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__oai211_1 _1212_ (.A1(WE_I),
    .A2(_0583_),
    .B(_0584_),
    .C(_0585_),
    .ZN(_0586_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _1213_ (.A1(DAT_O[3]),
    .A2(_0547_),
    .B1(_0548_),
    .B2(_0586_),
    .ZN(_0587_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1214_ (.A1(RST_I),
    .A2(_0587_),
    .ZN(_0147_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _1220_ (.A1(_0591_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _1221_ (.A1(DAT_O[4]),
    .A2(_0547_),
    .B1(_0548_),
    .B2(_0593_),
    .ZN(_0594_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1222_ (.A1(RST_I),
    .A2(_0594_),
    .ZN(_0148_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _1227_ (.A1(\counter_control_status_register[5] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__oai211_1 _1228_ (.A1(WE_I),
    .A2(_0597_),
    .B(_0598_),
    .C(_0599_),
    .ZN(_0600_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _1229_ (.A1(DAT_O[5]),
    .A2(_0547_),
    .B1(_0548_),
    .B2(_0600_),
    .ZN(_0601_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1230_ (.A1(RST_I),
    .A2(_0601_),
    .ZN(_0149_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _1236_ (.A1(_0605_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _1237_ (.A1(DAT_O[6]),
    .A2(_0547_),
    .B1(_0548_),
    .B2(_0607_),
    .ZN(_0608_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1238_ (.A1(RST_I),
    .A2(_0608_),
    .ZN(_0150_),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _1239_ (.A1(DAT_O[7]),
    .A2(_0547_),
    .ZN(_0609_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__oai31_1 _1249_ (.A1(_0551_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _1250_ (.A1(ERR_O),
    .A2(_0206_),
    .ZN(_0619_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi21_1 _1251_ (.A1(_0618_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__oai21_1 _1252_ (.A1(WE_I),
    .A2(_0617_),
    .B(_0204_),
    .ZN(_0620_),
    .VDD(VDD),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi22_1 _1253_ (.A1(ACK_O),
    .A2(_0206_),
    .B1(_0209_),
    .B2(_0620_),
    .ZN(_0621_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1254_ (.A1(RST_I),
    .A2(_0621_),
    .ZN(_0153_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _1257_ (.A1(\pulse_count_threshold_register[8] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi21_1 _1258_ (.A1(DAT_I[0]),
    .A2(_0622_),
    .B(RST_I),
    .ZN(_0625_),
    .VDD(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _1260_ (.A1(\pulse_count_threshold_register[9] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__aoi21_1 _1261_ (.A1(DAT_I[1]),
    .A2(_0622_),
    .B(RST_I),
    .ZN(_0627_),
    .VDD(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nand2_1 _1262_ (.A1(_0626_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1263_ (.A1(DAT_I[2]),
    .A2(_0623_),
    .ZN(_0628_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1264_ (.A1(\pulse_count_threshold_register[10] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor3_1 _1265_ (.A1(RST_I),
    .A2(_0628_),
    .A3(_0629_),
    .ZN(_0156_),
    .VDD(VDD),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1266_ (.A1(DAT_I[3]),
    .A2(_0623_),
    .ZN(_0630_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1267_ (.A1(\pulse_count_threshold_register[11] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor3_1 _1268_ (.A1(RST_I),
    .A2(_0630_),
    .A3(_0631_),
    .ZN(_0157_),
    .VDD(VDD),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1269_ (.A1(DAT_I[4]),
    .A2(_0623_),
    .ZN(_0632_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi211_1 _1270_ (.A1(_0166_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1271_ (.A1(DAT_I[5]),
    .A2(_0623_),
    .ZN(_0633_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1272_ (.A1(\pulse_count_threshold_register[13] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor3_1 _1273_ (.A1(RST_I),
    .A2(_0633_),
    .A3(_0634_),
    .ZN(_0159_),
    .VDD(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__aoi211_1 _1275_ (.A1(_0165_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1276_ (.A1(DAT_I[7]),
    .A2(_0623_),
    .ZN(_0636_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1277_ (.A1(\pulse_count_threshold_register[15] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor3_1 _1278_ (.A1(RST_I),
    .A2(_0636_),
    .A3(_0637_),
    .ZN(_0161_),
    .VDD(VDD),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1279_ (.A1(DAT_I[0]),
    .A2(_0212_),
    .ZN(_0638_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1280_ (.A1(\pulse_count_threshold_register[0] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor3_1 _1281_ (.A1(RST_I),
    .A2(_0638_),
    .A3(_0639_),
    .ZN(_0162_),
    .VDD(VDD),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1282_ (.A1(DAT_I[1]),
    .A2(_0212_),
    .ZN(_0640_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1283_ (.A1(\pulse_count_threshold_register[1] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor3_1 _1284_ (.A1(RST_I),
    .A2(_0640_),
    .A3(_0641_),
    .ZN(_0163_),
    .VDD(VDD),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1285_ (.A1(DAT_I[2]),
    .A2(_0212_),
    .ZN(_0642_),
    .VDD(VDD),
    .VNW(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__nor2_1 _1286_ (.A1(\pulse_count_threshold_register[2] ),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__nor3_1 _1287_ (.A1(RST_I),
    .A2(_0642_),
    .A3(_0643_),
    .ZN(_0164_),
    .VDD(VDD),
 ...
 gf180mcu_fd_sc_mcu7t5v0__dffq_1 _1452_ (.D(_0018_),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__dffq_1 _1453_ (.D(signal_input),
    .CLK(CLK_I),
    ...
    .VPW(VSS),
    .VSS(VSS));
 gf180mcu_fd_sc_mcu7t5v0__tiel _1454_ (.ZN(RTY_O),
    .VDD(VDD),
    .VNW(VDD),
    .VPW(VSS),
    .VSS(VSS));
